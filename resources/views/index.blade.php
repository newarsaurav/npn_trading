        ...
        <div class="container">
            <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-start" data-scrollax-parent="true">
                <div class="col-md-6 ftco-animate">
                    ...
                    <h1 class="mb-4">CLEANING,DEMOLISION AND WASTE MANAGEMENT COMPANY</h1>
                                        ...
                                        <div class="form-field">
                                            <div class="select-wrap">
                                                ...
                                                <select name="" id="" class="form-control">
                                                    ...
                                                    <option value="">Demolision</option>
        ...
        <div class="container">
            <div class="row d-flex no-gutters">
                <div class="col-md-6 d-flex">
                    <div class="img d-flex align-items-center justify-content-center py-5 py-md-0" style="background-image:url(images/about.png);">
                ...
                <div class="col-md-6 pl-md-5 pt-md-5">
                    <div class="row justify-content-start py-5">
                        <div class="col-md-12 heading-section ftco-animate">
                            <span class="subheading">Welcome to NPN TRADING</span>
            ...
            <div class="row">
                <div class="col-md-6 col-lg-4 services ftco-animate">
                    <div class="d-block d-flex">
                        ...
                        <div class="media-body pl-3">
                            <h3 class="heading">COMMERCIAL CLEANING SERVICES</h3>
                            <p>The presentation and cleanliness of your office space is paramount to the reputation of your brand...
                            </p>
                ...
                <div class="col-md-6 col-lg-4 services ftco-animate">
                    <div class="d-block d-flex">
                        ...
                        <div class="media-body pl-3">
                            ...
                            <p>When is comes to the health sector, cleanliness is of prime importance.
                                With more than years of experience ...</p>
                            <p><a href="#" class="btn-custom">Read more</a></p>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4 services ftco-animate">
                    <div class="d-block d-flex">
                        ...
                        <div class="media-body pl-3">
                            <h3 class="heading">GOVERNMENT</h3>
                            <p>Our experience of office cleaning and maintaining government assets for at least 30 years has made us fully aware...</p>
                            <p><a href="#" class="btn-custom">Read more</a></p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-4 services ftco-animate">
                    <div class="d-block d-flex">
                        ...
                        <div class="media-body pl-3">
                            <h3 class="heading">INDUSTRIAL</h3>
                            <p>The industrial sector demands a strong adherence to processes, systems and safety guidelines....</p>
                            <p><a href="#" class="btn-custom">Read more</a></p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-4 services ftco-animate">
                    <div class="d-block d-flex">
                        ...
                        <div class="media-body pl-3">
                            <h3 class="heading">PREVENTATIVE AND INFECTIOUS CLEANS</h3>
                            <p>With a team of professionals trained in infectious cleaning, we are here to help you decontaminate all areas in...</p>
                            <p><a href="#" class="btn-custom">Read more</a></p>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-6 col-lg-4 services ftco-animate">
                    <div class="d-block d-flex">
                        ...
                        <div class="media-body pl-3">
                            <h3 class="heading">Professional & Dedicated Services</h3>
                            <p>As one of Melbourne’s most reliable and respectable demolition companies, we have all the experience and techniques ...
                            </p>
                            <p><a href="#" class="btn-custom">Read more</a></p>
                        </div>
                    </div>
                ...
                <div class="col-md-6 col-lg-4 services ftco-animate">
                    <div class="d-block d-flex">
                        ...
                        <div class="media-body pl-3">
                            <h3 class="heading">Residential & Domestic Demolition Services</h3>
                            <p>When is comes to the health sector, cleanliness is of prime importance.
                                With more than years of experience ...</p>
                            <p><a href="#" class="btn-custom">Read more</a></p>
                        </div>
                ...
                <div class="col-md-6 col-lg-4 services ftco-animate">
                    <div class="d-block d-flex">
                        ...
                        <div class="media-body pl-3">
                            <h3 class="heading">Commercial Demolition Services </h3>
                            <p>Our experience of office cleaning and maintaining government assets for at least 30 years has made us fully aware of the complexities for at least 30 years...</p>
                            <p><a href="#" class="btn-custom">Read more</a></p>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-6 col-lg-4 services ftco-animate">
                    <div class="d-block d-flex">
                        ...
                        <div class="media-body pl-3">
                            <h3 class="heading">BINS AND COLLECTIONS</h3>
                            <p>As one of Melbourne’s most reliable and respectable demolition companies, we have all the experience and techniques ...
                            </p>
                            <p><a href="#" class="btn-custom">Read more</a></p>
                        </div>
                ...
                <div class="col-md-6 col-lg-4 services ftco-animate">
                    <div class="d-block d-flex">
                        ...
                        <div class="media-body pl-3">
                            <h3 class="heading">Recycling bin – yellow lid</h3>
                            <p>When is comes to the health sector, cleanliness is of prime importance.
                                With more than years of experience ...</p>
                            <p><a href="#" class="btn-custom">Read more</a></p>
                        </div>
                ...
                <div class="col-md-6 col-lg-4 services ftco-animate">
                    <div class="d-block d-flex">
                        ...
                        <div class="media-body pl-3">
                            <h3 class="heading">Food and garden organics bin </h3>
                            <p>Our experience of office cleaning and maintaining government assets for at least 30 years has made us fully aware of the complexities for at least 30 years...</p>
                            <p><a href="#" class="btn-custom">Read more</a></p>
                        </div>
                    </div>
